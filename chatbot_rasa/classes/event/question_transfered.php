 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class question_transfered extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_name_question_transfered', 'block_chatbot_rasa');
    }

    public function get_description() {
        return "L'utilisateur '{$this->userid}' a transféré les questions avec l'id du cours '{$this->other['oldcourseid']}' sur le cours '{$this->courseid}'.";// get_string('event_description_message_sent', 'block_chatbot_rasa');
    }
}
