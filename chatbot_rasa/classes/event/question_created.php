...
class question_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_name_question_created', 'block_chatbot_rasa');
    }

    public function get_description() {
        return "L'utilisateur '{$this->userid}' a créer une question avec l'id '{$this->objectid}' dans le cours '{$this->courseid}.'";// get_string('event_description_message_sent', 'block_chatbot_rasa');
    }
}
